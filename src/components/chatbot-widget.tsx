  ...
  return (
    <div className="fixed bottom-8 left-8 z-[60] flex flex-col items-start gap-4">
      {isOpen && (
        ...
        >
          <div className="border-b border-white/10 bg-navy-900/40 px-5 py-3">
          ...
          <div className="space-y-4 px-5 py-4 text-sm text-white/80">
            ...
            <div className="space-y-2">
              <a
                ...
                className="block w-full rounded-full bg-navy-900 px-4 py-2 text-left font-semibold text-white shadow-[0_18px_42px_-28px_rgba(15,23,42,0.9)] transition-colors hover:bg-navy-800"
              >
          ...
          >
            ...
            <button
              type="submit"
              className="inline-flex h-10 items-center justify-center rounded-full bg-navy-900 px-4 text-xs font-semibold uppercase tracking-[0.28em] text-white transition-colors hover:bg-navy-800"
            >
              Senden
            </button>
          </form>
      ...
      <button
        ...
        className="relative flex h-20 w-20 items-center justify-center rounded-full bg-navy-900 text-white shadow-[0_35px_90px_-45px_rgba(15,23,42,0.65)] transition-colors hover:bg-navy-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-navy-700"
      >
